...
export async function syncCashProfileToAssumptionOverrides(
  ...
  await Promise.all([
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('billing_model')?.unit ?? undefined,
    ...
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('receipt_cycle_days')?.unit ?? undefined,
    ...
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('advance_percentage')?.unit ?? undefined,
    ...
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('final_delivery_percentage')?.unit ?? undefined,
    ...
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('working_capital_buffer_days')?.unit ?? undefined,
...
export async function syncDisbursementProfileToAssumptionOverrides(
  ...
  await Promise.all([
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('disbursement_model')?.unit ?? undefined,
    ...
    upsertProjectAssumptionOverride({
      ...
      unit: CORE_PARAMETER_MAP.get('supplier_payment_cycle_days')?.unit ?? undefined,
